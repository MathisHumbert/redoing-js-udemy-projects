...
const displayReviews = (value) => {
  img.removeAttribute('src');
  let newImg = reviews[value].img;
  img.setAttribute('src', newImg);
  name.textContent = reviews[value].name;
  job.textContent = reviews[value].job;
  text.textContent = reviews[value].text;
};

displayReviews(value);

btns.addEventListener('click', (e) => {
  let btn = e.target.parentElement.classList;
